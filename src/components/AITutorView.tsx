                        ...
                        <div className="flex items-center gap-3 pt-1 border-t border-slate-200/50 mt-1">
                          ...
                          {msg.suggestedAction && (
                            <button
                              ...
                              className="px-2.5 py-1 rounded-lg bg-purple-100 text-purple-800 font-extrabold text-xs hover:bg-purple-200 transition-colors cursor-pointer"
                            >
